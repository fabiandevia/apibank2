...
$app->post('/api/clientes/agregar', function(Request $request, Response $response){
    ...
    $consulta = "INSERT INTO clientes (nombre, apellido, direccion, ciudad, zona, fecha_de_nacimiento, ciudad_nacimiento, email, cedula, tipo_identificacion, celular, telefono, tipo_empleo, empresa, cargo, antiguedad, sueldo, deudas, referido, telefono_referido) VALUES 
